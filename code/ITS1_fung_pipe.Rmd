...
The following is a set of instructions of what the ITS1_fun_pipe.sh is doing 
To run ITS1_fung_pipe.sh simply navigate to the code directory and execute the file. 
...
* INPUT: R1_stripped.fastq
* OUTPUT: R1_stats_result_vsearch.txt 

We have to make a decision on where to truncate the reads based on this output file 
for more information go to [this webpage to learn more](http://drive5.com/usearch/manual/cmd_fastq_stats.html)
...
* INPUT: R1_stripped.fastq
* OUTPUT: R1_filtered.fasta, R1_filtered.fastq
...
* INPUT: R1_filtered.fastq
* OUTPUT: R1_trimmed.fasta, R1_trimmed.fastq
...
* INPUT: R1_trimmed.fastq
* OUTUT: R1_trimmed_fastqc.zip, R1_trimmed_fastqc.html
...
* INPUT: R1_trimmed.fasta 
* OUTPUT: R1_dereplicated.fasta
...
* INPUT: R1_dereplicated.fasta 
* OUTPUT: R1_no_singletons.fasta
...
* INPUT: R1_no_singletons.fasta 
* OUTPUT: R1_otus.fasta
...
* INPUT: R1_otus.fasta 
* OUTPUT: R1_otus_no_chimera_ref.fasta
...
* INPUT: R1_otus_no_chimera_ref.fasta
* OUTPUT: R1_otus_numbered.fasta
...
* INPUT: R1_otus_numbered.fasta
* OUTPUT: R1_otu_map.uc
...
* INPUT: R1_otus_numbered.fasta
* OUTPUT: R1_taxonomy_otutaxout.utax
...
* INPUT: R1_taxonomy_otutaxout.utax
* OUTPUT: R1_taxonomy_otutaxout.utax
...
* INPUT: R1_otu_table.txt
* OUTPUT: R1_otu_table.biom
...
* INPUT: 
  * .biom file: R1_otu_table.biom
  * tax file:   R1_taxonomy_otutaxout__RDP.txt
* OUTPUT: R1_otu_table_tax.biom
...
* INPUT: R1_otu_table_tax.biom
* OUTPUT: R1_otu_table_tax_json.biom
...
Now you are ready to run R analysis on the files located in the input_files directory 
